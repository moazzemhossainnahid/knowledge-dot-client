    ...
    return (  
        <div>
            <footer class="footer w-full grid grid-cols-1 lg:grid-cols-5 gap-3 p-10 bg-gray-900 text-gray-300">
                <div>
                    <span class=" uppercase w-full lg:w-1/5 text-white text-xl font-semibold pb-5">Contact</span>
                ...
                <div>
                    <span class=" uppercase w-full lg:w-1/5 text-white text-xl font-semibold pb-5">Company</span>
                ...
                <div>
                    <span class=" uppercase w-full lg:w-1/5 text-white text-xl font-semibold pb-5">Programs</span>
                ...
                <div>
                    <span class=" uppercase w-full lg:w-1/5 text-white text-xl font-semibold pb-5">Support</span>
                    <a href="#!" class=" hover:pl-2 duration-300">Terms of use</a>
                    <a href="#!" class=" hover:pl-2 duration-300">Privacy policy</a>
                    <a href="#!" class=" hover:pl-2 duration-300">Cookie policy</a>
                </div>
                <div>
                    <span class=" uppercase w-full lg:w-1/5 text-white text-xl font-semibold pb-5">Mobile</span>
            ...
            <footer class="footer px-10 py-4 flex justify-center items-center bg-black">
                <div class="items-center justify-center grid-flow-col">
                    <p className="text-gray-300 text-center">Copyright © 2022 Theme by Knowledge Dot. All Rights Reserved.</p>
                    </div>
            </footer>
        </div>
    );
