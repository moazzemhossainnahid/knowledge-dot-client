...
const TopVideoSec = ({ course }) => {
  ...
  return (
    <div className="container w-full">
      <h3 className="text-xl md:text-3xl lg:text-5xl font-semibold text-left">
        {course?.name}
      </h3>
        ...
        <div className=" w-full lg:w-2/6 text-left p-5">
          <div className="w-full">
            ...
            <button
              ...
              className="border-orange-600 w-full text-sm border-2 px-7 mx-auto py-2 rounded font-semibold bg-orange-600 text-white hover:bg-white hover:text-orange-600 my-5 duration-300"
            >
              Enroll This Course
            </button>
          </div>
          <div className="py-5">
            ...
            <div className="text-left grid grid-cols-1">
              ...
              <div className="flex justify-start items-center py-3">
                ...
                <p className="text-md font-semibold">
                  Lectures - {course?.files?.length} Lessons
                </p>
              </div>
